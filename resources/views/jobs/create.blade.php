    ...
    >
        ...
        >
            ...
            <div class="mb-4">
                ...
                >
                    <option value="Full-Time" {{ olg('job_type') == 'Full-Time' ? 'selected' : '' }}>
                        Full-Time
                    </option>
                    <option value="Part-Time" {{ olg('job_type') == 'Part-Time' ? 'selected' : '' }}>
                        Part-Time
                    </option>
                    <option value="Contract" {{ olg('job_type') == 'Contract' ? 'selected' : '' }}>
                        Contract
                    </option>
                    <option value="Temporary" {{ old('job_type') == 'Temporary' ? 'selected' : '' }}>
                        Temporary
                    </option>
                    <option value="Internship" {{ olg('job_type') == 'Internship' ? 'selected' : '' }}>
                        Internship
                    </option>
